...
//    private var aiMessagePosition: Int = -1
//
//    enum class MessageType { USER, AI }
...
//                chatList.add(ChatMessage("AI思考中...", MessageType.AI))
//                aiMessagePosition = chatList.size - 1
//                chatAdapter.notifyItemInserted(aiMessagePosition)
//                binding.chatRecyclerView.scrollToPosition(aiMessagePosition)
//
//                // 2. 发起流式请求（改用Handler处理UI更新）
//                currentAiJob = CoroutineScope(Dispatchers.IO).launch {
//                    DeepSeekHelper().sendMessageStream(input) { partialResponse ->
//                        // 直接用Handler切换到主线程（替代withContext）
//                        Handler(Looper.getMainLooper()).post {
//                            if (aiMessagePosition != -1 && aiMessagePosition < chatList.size) {
//                                chatList[aiMessagePosition] = ChatMessage(partialResponse, MessageType.AI)
//                                chatAdapter.notifyItemChanged(aiMessagePosition)
//                                binding.chatRecyclerView.scrollToPosition(aiMessagePosition)
//                            }
//                        }
...
//
//        override fun getItemViewType(position: Int): Int =
//            if (messages[position].type == MessageType.USER) TYPE_USER else TYPE_AI
//
//        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
...
//            when (holder) {
//                is UserViewHolder -> holder.content.text = msg.content
//                is AiViewHolder -> holder.content.text = msg.content
//            }
//        }
//
